...
- **THEN** the tool discovers available skills and subagents in the repo, prompts the user to select which to install (or all), appends the dependency to `agents.yaml`, and installs them
